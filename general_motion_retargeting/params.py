...
ROBOT_XML_DICT = {
    ...
    "tfbot": ASSET_ROOT / "tfbot" / "tfbot_mocap.xml",
    "tfbot_g1_scene": ASSET_ROOT / "tfbot" / "tfbot_mocap_g1_scene.xml",
    "human_only": ASSET_ROOT / "human_viewer_scene.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "smplx":{
        ...
        "tfbot": IK_CONFIG_ROOT / "smplx_to_tfbot.json",
        "tfbot_g1_scene": IK_CONFIG_ROOT / "smplx_to_tfbot.json",
    },
    "bvh_lafan1":{
