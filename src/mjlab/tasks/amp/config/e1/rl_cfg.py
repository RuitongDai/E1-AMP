"""RL configuration for E1 AMP task."""
...
from mjlab.tasks.amp.config.e1.symmetry import compute_symmetric_states


def e1_amp_runner_cfg() -> RslRlAmpOnPolicyRunnerCfg:
  """Create RL runner configuration for Booster E1 AMP task."""
