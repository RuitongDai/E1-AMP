"""TFBOT AMP environment configuration."""
...
from mjlab.asset_zoo.robots import TFBOT_ACTION_SCALE, get_tfbot_robot_cfg
...
MOTION_DATA_DIR = str(
  Path(__file__).resolve().parent.parent.parent / "data" / "tfbot_motions"
)

AMP_NUM_STEPS = 3
ANIMATION_TERM_NAME = "tfbot_anim"
MOTION_DATA_TERM_NAME = "tfbot_motion"


def tfbot_amp_env_cfg(play: bool = False) -> AmpEnvCfg:
  """Create an AMP environment configuration for TFBOT."""
  ...
  foot_bodies = ("l_ankle_pitch_link", "r_ankle_pitch_link")
  ...
  motion_data = {
    MOTION_DATA_TERM_NAME: MotionDataTermCfg(
      ...
      motion_data_weights={
        ...
        "male_walk_turn_left_90": 1.0,
        "male_walk_turn_right_90": 1.0,
      },
    )
  }
  ...
  cfg.scene.entities = {"robot": get_tfbot_robot_cfg()}
  ...
  if play:
    ...
    cfg.curriculum = {}
    # Fixed forward velocity command for stable play behavior.
